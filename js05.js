...
function createLightbox() {
   ...
   //deisgn the lighbox previous slide button
   ...
   //fucntion to move forward through the image list
   function showNext() {
      lbImages.appendChild(lbImages.firstElementChild);
      (currentImg < imgCount) ? currentImg++ : currentImg = 1;
      lbCounter.textContent = currentImg + " / " + imgCount;
   }
   //fucntion to move backward through the image list
   function showPrev() {
   ...
   //add the image to the figure bix
   let overlayImage = this.cloneNode("true");
   figureBox.appendChild(overlayImage);

   //Add the caption to the figure bix
